document.querySelector('.busca').addEventListener('submit', async (event) => {
    event.preventDefault();  /* evebt submit e async*/
    ...
    if(input !== '') {
        ...
        ${encodeURI(input)}&units=metric&lang=pt_br&appid=d06cdb298fafc83c520d5ab677fc477e`); /* units metric, lang e api key */
        let json = await results.json();  /* encodeURI, wait e  fetch*/
